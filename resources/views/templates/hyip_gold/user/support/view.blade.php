...
@section('content')
    <div class=" section-common-bg {{ auth()->check() ? '' : 'pb-120 pt-120' }}">
                        ...
                        <div class="card-body">
                            @if ($myTicket->status != 4)
                                <form method="post" action="{{ route('ticket.reply', $myTicket->id) }}"
                                    ...
                                    <div class="text-end">
                                        <a href="javascript:void(0)" class="btn--base btn-sm addFile"><i
                                                class="fa fa-plus"></i>
                                            @lang('Add New')</a>
                                    </div>
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="file" name="attachments[]"
                                            class="form-control form--control attached" />
                                    ...
                                    <button type="submit" class="btn btn--outline-base w-100"> <i class="fa fa-reply"></i>
                                        @lang('Reply')</button>
                                </form>
                            @endif
                        </div>
    ...
    <x-confirmation-modal closeBtn="btn--danger btn-md" submitBtn="btn--base btn-md" customModal="custom--modal" />
@endsection
@push('style')
    <style>
            ...
            $('.addFile').on('click', function() {
                ...
                $("#fileUploadsContainer").append(`
                    <div class="input-group my-3">
                        <input type="file" name="attachments[]" class="form-control form--control attached" required />
