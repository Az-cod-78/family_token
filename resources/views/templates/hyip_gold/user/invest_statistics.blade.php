            ...
            <div class="card custom--card h-100">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap justify-content-between mt-3 mt-sm-4 gap-2">
                        <a href="{{ route('plan') }}" class="btn btn--sm btn--outline-base">@lang('Invest Now') <i
                                class="las la-arrow-right fs--12px ms-1"></i></a>
                        <a href="{{ route('user.withdraw') }}" class="btn btn--sm btn--outline-base">@lang('Withdraw Now') <i
                                class="las la-arrow-right fs--12px ms-1"></i></a>
                    </div>
                </div>
            </div>
    ...
    <div class="row justify-content-center mt-4">
        <div class="col-md-12">
            <div class="text-end mb-4">
                <a href="{{ route('user.invest.log') }}" class="btn btn--outline-base btn-sm">
                    @lang('Investments')
                </a>
            </div>
        </div>
